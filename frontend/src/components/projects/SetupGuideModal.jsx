        ...
        <div className="sgm-body">
          ...
          {activeStep === 0 && (
            <div className="sgm-step-content">
              ...
              <div className="sgm-note">
                ✅ <strong>Note for SPA apps</strong> (React Router, Vue Router, Angular): The script tracks both the initial page load and client-side route changes automatically.
                If your project has login, Step 3 shows how to optionally send logged-in visitor name/email after login.
              </div>
            </div>
          )}
