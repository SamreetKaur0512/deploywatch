...
4. Add these environment variables:
   - `PORT=10000` (Render will override this automatically, but keeping it is fine)
...
2. For Render: create a Static Site and set **Build Command**: `npm install && npm run build`, **Publish Directory**: `dist`
